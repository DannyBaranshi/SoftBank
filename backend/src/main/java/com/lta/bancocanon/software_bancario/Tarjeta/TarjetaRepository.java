...
public interface TarjetaRepository extends JpaRepository<TarjetaDTO, Integer>{
    ...
    // Buscar tarjetas por usuario a través de la cuenta asociada
    java.util.List<TarjetaDTO> findByCuentaUsuario(com.lta.bancocanon.software_bancario.Usuario.Usuario usuario);
